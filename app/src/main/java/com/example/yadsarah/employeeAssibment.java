...
public class employeeAssibment  extends AppCompatActivity {


    database_employeeAssibment mydb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_assibment);
        ...
        add.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isInserted == true) {
                            Toast.makeText(employeeAssibment.this, "shift added", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(employeeAssibment.this, "error, try again ", Toast.LENGTH_LONG).show();
                        }
    ...
    public void remove() {
        remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(employeeAssibment.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (deletedRow > 0) {
                            Toast.makeText(employeeAssibment.this, "Shift deleted", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(employeeAssibment.this, "Shift not deleted", Toast.LENGTH_LONG).show();
                        }
                    }
                });

...
public class ElevatorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int ORDER_LOADER = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        walkToolName.setText("Elevator");
        walkImageView.setImageResource(R.drawable.elevator_img);
        ...
        walkAddtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveCart();
                Intent intent = new Intent(ElevatorActivity.this, SummaryActivity.class);
    ...
    private void decreaseQuantity() {
        ...
        if (quantity == 0) {
            Toast.makeText(ElevatorActivity.this, "Can't decrease quantity below zero", Toast.LENGTH_SHORT).show();
        } else {
            quantity--;
            displayQuantity();
        }

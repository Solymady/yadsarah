...
public class volunteerAssibment extends AppCompatActivity {


    database_volunteerAssibment mydb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_val_shift_assbmint);
        mydb = new database_volunteerAssibment(this);
        ...
        add.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (isInserted == true) {
                            Toast.makeText(volunteerAssibment.this, "shift added", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(volunteerAssibment.this, "error, try again ", Toast.LENGTH_LONG).show();
                        }
    ...
    public void remove() {
        remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(volunteerAssibment.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (deletedRow > 0) {
                            Toast.makeText(volunteerAssibment.this, "Shift deleted", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(volunteerAssibment.this, "Shift not deleted", Toast.LENGTH_LONG).show();
                        }
                    }
                });

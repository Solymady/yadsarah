...
public class TreadmillActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int ORDER_LOADER = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        walkToolName.setText("Treadmill For Adults");
        walkImageView.setImageResource(R.drawable.treadmill_for_adults_img);
        ...
        walkAddtoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveCart();
                Intent intent = new Intent(TreadmillActivity.this, SummaryActivity.class);
    ...
    private void decreaseQuantity() {
        ...
        if (quantity == 0) {
            Toast.makeText(TreadmillActivity.this, "Can't decrease quantity below zero", Toast.LENGTH_SHORT).show();
        } else {
            quantity--;
            displayQuantity();
        }

...
public class database_sc_employee extends SQLiteOpenHelper {

    public static final String DATABASE_NAME ="yadSarah3.db";
    public static final String TABLE_NAME ="sc_managerToEmployee";
    ...
    public database_sc_employee(@Nullable Context context) {

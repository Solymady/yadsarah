...
public class shiftWorker extends AppCompatActivity {

    database_sc_employee mydb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shift_worker);

        mydb=new database_sc_employee(this);
        ...
        add.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(isInserted=true){
                            Toast.makeText(shiftWorker.this,"shift added",Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(shiftWorker.this,"error, try again ",Toast.LENGTH_LONG).show();
                        }
    ...
    //show daialog to the user to choose date
    ...
    public void remove() {
        remove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(shiftWorker.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (deletedRow > 0) {
                            Toast.makeText(shiftWorker.this, "Shift deleted", Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(shiftWorker.this, "Shift not deleted", Toast.LENGTH_LONG).show();
                        }
                    }
                });
